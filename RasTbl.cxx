...
EndpointRec::EndpointRec(
    ...
    m_useIPSec(false), m_additiveRegistrant(false), m_addCallingPartyToSourceAddress(false), m_forceTerminalType(-1), m_forceDirectMode(false), m_authenticators(NULL),
