...
const DictInitializer ITU_T_E164_CodeTables::AssignedNetworkIdentificationCode[] = {
	...
	{"12","assigned to  MCI [HyperStream International (HSI) Data Network]"},
	{"13","assigned to Telespazio S.p.A. [EMS Regional Mobile Satellite System]"},
	{"14","assigned to Verizon [GTE International Networks]"},
	{"15","assigned to Telstra [ITERRA Digital Network]"},
	{"16","assigned to United Arab Emirates Administration [Thuraya RMSS Network]"},
	{"17","reserved for AT&T [AT&T International ATM Network]"},
	{"18","abandoned by Teledesic [Teledesic Global Network]"},
	...
	{"21","abandoned by Ameritech [Gateway Global Service, Inc. (AGGSI) network]"},
	...
	{"24","assigned to Telia AB [Telia multinational ATM Network]"},
	{"25","abandoned by Constellation Communications, Inc. [Constellation System]"},
	{"26","reserved for SBC Communications Inc. - Global Data Network"},
	{"27","reserved for Williams Communications"},
	{"28","reserved for Deutsche Telekom"},
	{"29","assigned to Q-Tel (NZ) Ltd (Formerly World IT)"},
	{"30","reserved for Singapore Telecom"},
	{"31","assigned to Telekom Malaysia"},
	{NULL,NULL}
};
...
const DictInitializer ITU_T_E164_CodeTables::AssignedGMSSNetworkIdentificationCode[] = {
	...
	{"2","assigned to Ellipso (formerly assigned to Odyssey)"},
	{"3","assigned to Ellipso (formerly assigned to Odyssey)"},
